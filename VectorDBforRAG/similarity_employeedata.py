...
def performed_advanced_search(collection, all_items):
    try:
        ...
        for i, (doc_id, document, distance) in enumerate(zip(result['ids'][0],result['documents'][0],result['distances'][0])):
        ...
        ## Meta data filtering example
        print("\n === Metadata Filtering Examples ===")

        # Example 1. Filter byt department
        ...
        print(f"Error in advances search: {e}")
...
def main():
    try:    
        ...
        for employee in employees:
            documents = f"{employee['role']} with {employee['experience']} years of experience in {employee['department']}. "
            documents += f"Skills: {employee['skills']}. Located in {employee['location']}."
            documents += f"Employment type: {employee['employment_type']}"
            employee_documents.append(documents)
        ...
        performed_advanced_search(collection, all_items)
    except Exception as e:
        print(f"Error: {e}")
